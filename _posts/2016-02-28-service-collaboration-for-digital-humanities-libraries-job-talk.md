---
layout: post
title: Service +/- collaboration for digital humanities in the library (a DH job talk)
permalink: 2016/02/28/DHjobtalk
author: 
...
Here's the job talk I gave in July 2015 for my present role as a digital humanities assistant professor (aka "Digital Humanities Specialist" aka librarian faculty) in the Purdue Libraries ([link to the original job ad](/assets/DigitalHumanitiesSpecialist.pdf)). I'm hoping this can help other job seekers, so I've only very lightly edited this (all cited sources are gathered in [a Zotero bibliography](http://tinyurl.com/dhlibraries)). The requested presentation topic:
...
![PurdueJobTalkImages.006]({{ site.baseurl }}/assets/PurdueJobTalkImages/PurdueJobTalkImages.006.jpeg)
...
![PurdueJobTalkImages.008]({{ site.baseurl }}/assets/PurdueJobTalkImages/PurdueJobTalkImages.008.jpeg)
...
![PurdueJobTalkImages.009]({{ site.baseurl }}/assets/PurdueJobTalkImages/PurdueJobTalkImages.009.jpeg)
...
![PurdueJobTalkImages.011]({{ site.baseurl }}/assets/PurdueJobTalkImages/PurdueJobTalkImages.011.jpeg)
...
![PurdueJobTalkImages.012]({{ site.baseurl }}/assets/PurdueJobTalkImages/PurdueJobTalkImages.012.jpeg)
...
![PurdueJobTalkImages.013]({{ site.baseurl }}/assets/PurdueJobTalkImages/PurdueJobTalkImages.013.jpeg)
...
![PurdueJobTalkImages.014]({{ site.baseurl }}/assets/PurdueJobTalkImages/PurdueJobTalkImages.014.jpeg)
...
![PurdueJobTalkImages.015]({{ site.baseurl }}/assets/PurdueJobTalkImages/PurdueJobTalkImages.015.jpeg)
...
![PurdueJobTalkImages.016]({{ site.baseurl }}/assets/PurdueJobTalkImages/PurdueJobTalkImages.016.jpeg)
...
![PurdueJobTalkImages.017]({{ site.baseurl }}/assets/PurdueJobTalkImages/PurdueJobTalkImages.017.jpeg)
...
![PurdueJobTalkImages.018]({{ site.baseurl }}/assets/PurdueJobTalkImages/PurdueJobTalkImages.018.jpeg)
...
![PurdueJobTalkImages.019]({{ site.baseurl }}/assets/PurdueJobTalkImages/PurdueJobTalkImages.019.jpeg)
...
![PurdueJobTalkImages.020]({{ site.baseurl }}/assets/PurdueJobTalkImages/PurdueJobTalkImages.020.jpeg)
...
![PurdueJobTalkImages.021]({{ site.baseurl }}/assets/PurdueJobTalkImages/PurdueJobTalkImages.021.jpeg)

I've worked since 2009 in various roles at a thriving, library-based DH center, the [Maryland Institute of Technology in the Humanities](http://mith.umd.edu), (or "MITH"), on a wide variety of projects (logos for some of these projects are on the screen). I've had the chance to experience a spectrum of approaches to DH service in the library, from sometimes more service-style DH website and tool creation, moving over the years to largely focus on collaboration and growing campus relationships.
...
![PurdueJobTalkImages.023]({{ site.baseurl }}/assets/PurdueJobTalkImages/PurdueJobTalkImages.023.jpeg)

MITH has even improved on their successful model of more engaged fellowships through a series of ["DH Incubator" workshops](http://mith.umd.edu/research/digital-humanities-incubator-2012-13/) led by Trevor Munoz and Jennifer Guiliano. These workshops took place throughout a term and were open to any library faculty curious about DH (workshops for other types of researcher, such as last year's workshops on research with social media, drew attendees from across campus including non-humanities departments). In the first of these incubator workshops, librarians learn foundational DH concepts and approaches, and at the end of the term, those who want to go on and try a DH project, pitch one in front of the group. MITH then picked among these pitches when choosing who to support for its next round of library faculty fellowships.

![PurdueJobTalkImages.024]({{ site.baseurl }}/assets/PurdueJobTalkImages/PurdueJobTalkImages.024.jpeg)

This incubator model serves a couple purposes: librarians across the library become ambassadors for DH, and gain some new tools for their scholarship. Also, the DH center takes on some new projects, from library staff who are already daily saturated in the collection they're hoping to digitally work with. 
These workshops are team-taught and very hands-on, so the workshops *themselves*, model how to be the kind of collaborator, who's a valued member of a DH project team. This incubator model could work well for faculty outside the library too. A DH incubator for *students*, could teach the skills of working in a small and interdisciplinary team, that humanities students often don't get much of a chance to build.

![PurdueJobTalkImages.026]({{ site.baseurl }}/assets/PurdueJobTalkImages/PurdueJobTalkImages.026.jpeg)
...
![PurdueJobTalkImages.027]({{ site.baseurl }}/assets/PurdueJobTalkImages/PurdueJobTalkImages.027.jpeg)
...
![PurdueJobTalkImages.028]({{ site.baseurl }}/assets/PurdueJobTalkImages/PurdueJobTalkImages.028.jpeg)
...
![PurdueJobTalkImages.029]({{ site.baseurl }}/assets/PurdueJobTalkImages/PurdueJobTalkImages.029.jpeg)
