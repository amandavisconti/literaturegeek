---
layout: post
title: Infinite Ulysses beta closes for 1.0 work
permalink: 2016/06/02/infinite-ulysses-beta-closes
tags: [digital-humanities, infinite-ulysses, scholarly-web-design-and-coding, best]
status: publish
type: post
published: true
---
...
**A huge thanks to all the site's beta testers**, who generously gave me feedback on the site's design and how it fit their individual reader and research needs. (And another shout-out to all the people whose code and support made the site possible, [listed here](http://www.infiniteulysses.com/credits)—especially [Michael Widner](https://twitter.com/mwidner), whose development of the [Lacuna annotation platform](http://www.lacunastories.com/) you should definitely check out!.) 

Though there wasn't a race for quantity over quality, special thanks are due to the site's power annotators for their generosity to our reader community, and for helping me design the next iteration of the site to better support heavy annotation: user **tim finnegan** outpacing us all with 546 excellent annotations, followed by **bbogle** (159) and by three users with 20-30 annotations each—**pbohan**, **serinamarie89**, and **wvarga7a1**. I also authored 248 annotations myself, although many of these were drawn from my earlier [UlyssesUlysses.com](http://www.UlyssesUlysses.com) annotations. 
...
![Line chart of site visitors since the site when live, with spike in April 2015]({{ site.baseurl }}/assets/statriseandfall.png)
...
![Panel from Alison Bechdel's graphic novel Fun Home, showing the protagonist reading Ulysses and swearing]({{ site.baseurl }}/assets/AlisonBechdelUlysses.png)
...
This is a fun project, and I've been honored by the generosity of others in helping me build something better. So: I'm going to stop saying the new site will be ready soon, and wait until I can make and keep a promise about the site's next version. Any thoughts on making this hiatus better for readers (or other ideas for the site) are always appreciated!

The Infinite Ulysses site will remain available for looking at [here](http://www.InfiniteUlysses.com) until it's ready for further interactive use. If you're interested in reading more about the work behind Infinite Ulysses, you might fancy the dissertation around the edition at [dr.AmandaVisconti.com](http://dr.AmandaVisconti.com), including a whitepaper discussing stuff like designing interfaces for a public humanities, how public humanities participation can be meaningful without necessarily using full "critical" academic rhetoric, an analysis of past annotation and digital *Ulysses* projects as well as my Infinite Ulysses user testing, and some thoughts on whether Infinite Ulysses is an edition (for my textual scholarship peeps.) There's also [the full set of blog posts written during my dissertation available here](http://literaturegeek.com/tag/dissertation/).
